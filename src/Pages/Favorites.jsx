      ...
      <div className="bg-gray-100 text-gray-900 py-12 border-b border-gray-200">
        <div className="container mx-auto px-4">
          ...
          <p className="text-gray-600">
            Your saved tracks and videos live here. Remove or jump back in anytime.
          </p>
        </div>
      </div>
        ...
        {favorites.length === 0 ? (
          <div className="bg-gray-50 border border-dashed border-gray-300 rounded-2xl p-10 text-center">
            ...
            <p className="text-gray-600 mb-6">
              Start exploring and tap the heart to build your collection.
            </p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <Link
                to="/shorts"
                className="bg-gray-900 text-white font-semibold px-6 py-3 rounded-lg hover:bg-black"
              >
                Watch Videos
              </Link>
            </div>
